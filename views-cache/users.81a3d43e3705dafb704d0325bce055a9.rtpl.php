...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
          ...
          <div class="box-header">
            <a href="/admin/users/create" class="btn btn-success">Cadastrar Usuário</a>
            <!-- paginação e busca de usuários aula 123 -->
            <div class="box-tools">
            ...
            <div class="box-body no-padding">
              <table class="table table-striped">
                ...
                <tbody>
                  <!-- mostra os resultados do array com chave e valor -->
                  <?php $counter1=-1;  if( isset($users) && ( is_array($users) || $users instanceof Traversable ) && sizeof($users) ) foreach( $users as $key1 => $value1 ){ $counter1++; ?> <!-- no rain tpl, loop com os resultados dos usuarios -->
                    <tr>
                      ...
                      <td><?php if( $value1["inadmin"] == 1 ){ ?>Sim<?php }else{ ?>Não<?php } ?></td> <!-- if no rain tpl é declarado assim -->
                      <td>
