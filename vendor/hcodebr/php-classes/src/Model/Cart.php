...
class Cart extends Model {
	...
	public function getProducts()
	{
		...
		$rows = $sql->select("SELECT b.idproduct, b.desproduct, b.vlprice, b.vlheight, b.vllength, b.vlweight, b.desurl, COUNT(*) AS nrqtd, SUM(b.vlprice) AS vltotal FROM tb_cartsproducts a INNER JOIN tb_products b ON a.idproduct = b.idproduct WHERE a.idcart = :idcart AND a.dtremoved IS NULL GROUP BY b.idproduct, b.desproduct, b.vlprice, b.vlheight, b.vllength, b.vlweight, b.desurl ORDER BY b.desproduct",[
